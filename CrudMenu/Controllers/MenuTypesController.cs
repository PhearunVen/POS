...
namespace CrudMenu.Controllers
{
    public class MenuTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MenuTypeId,MenuTypeName")] MenuType menuType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuTypeId,MenuTypeName")] MenuType menuType)
        {
